...
function Sidebar({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: cn("relative w-64 bg-transparent transition-[width] duration-200 ease-linear", "group-data-[collapsible=offcanvas]:w-0", "group-data-[side=right]:rotate-180", variant === "floating" || variant === "inset" ? "group-data-[collapsible=icon]:w-[calc(3rem+1rem)]" : "group-data-[collapsible=icon]:w-12")
  }), /*#__PURE__*/React.createElement("div", _extends({
    "data-slot": "sidebar-container",
    className: cn("fixed inset-y-0 z-10 hidden h-svh w-64 transition-[left,right,width] duration-200 ease-linear md:flex", side === "left" ? "left-0 group-data-[collapsible=offcanvas]:-left-64" : "right-0 group-data-[collapsible=offcanvas]:-right-64",
    // Adjust the padding for floating and inset variants.
    variant === "floating" || variant === "inset" ? "p-2 group-data-[collapsible=icon]:w-[calc(3rem+1rem+2px)]" : "group-data-[collapsible=icon]:w-12 group-data-[side=left]:border-r group-data-[side=right]:border-l", className)
